...
(function() {
  ...
  CelestialBodyForm = (function() {
    ...
    CelestialBodyForm.prototype.add = function(referenceBody, callback) {
    ...
    CelestialBodyForm.prototype.edit = function(body, fixedReferenceBody, callback) {
      var orbit;
      this.callback = callback;
      $('.form-group', this.form).removeClass('has-error');
      $('.help-block', this.form).hide();
    ...
    CelestialBodyForm.prototype.save = function() {
      var argumentOfPeriapsis, body, eccentricity, inclination, k, longitudeOfAscendingNode, mass, meanAnomalyAtEpoch, name, newBody, orbit, originalBody, originalName, radius, ref, referenceBody, semiMajorAxis, timeOfPeriapsisPassage;
