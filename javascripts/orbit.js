...
(function() {
  ...
  ejectionAngle = function(vsoi, theta, prograde) {
    var a, ax, ay, az, b, c, cosTheta, g, q, ref, vx, vy;
    ref = normalize(vsoi), ax = ref[0], ay = ref[1], az = ref[2];
  ...
  Orbit.refineTransfer = function(transfer, transferType, originBody, destinationBody, t0, dt, initialOrbitalVelocity, finalOrbitalVelocity) {
    var a, argumentOfPeriapsis, dtFromSOI, e, ejectionOrbit, i, initialOrbitRadius, j, lastEjectionDeltaVector, longitudeOfAscendingNode, mu, nu, orbit, originOrbit, originTrueAnomalyAtSOI, originVelocityAtSOI, p1, prograde, rsoi, t1, tempBody, v1, vsoi;
    if (!initialOrbitalVelocity) {
      return transfer;
    }
    for (i = j = 1; j <= 10; i = ++j) {
