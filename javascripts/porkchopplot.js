...
(function() {
  var PALETTE, PLOT_HEIGHT, PLOT_WIDTH, PLOT_X_OFFSET, PorkchopPlot, TIC_LENGTH, i, k, l, m, n, o;
  ...
  for (i = l = 133; l <= 255; i = ++l) {
    PALETTE.push([128, i, 255]);
  }

  for (i = m = 255; m >= 128; i = --m) {
    PALETTE.push([128, 255, i]);
  }

  for (i = n = 128; n <= 255; i = ++n) {
    PALETTE.push([i, 255, 128]);
  }

  for (i = o = 255; o >= 128; i = --o) {
  ...
  PorkchopPlot = (function() {
    ...
    function PorkchopPlot(container) {
      ...
      this.canvas.mousemove((function(_this) {
        return function(event) {
          var offsetX, offsetY, pointer, ref, ref1, x, y;
          if ((_this.deltaVs != null) && (_this.dragStart == null)) {
            offsetX = ((ref = event.offsetX) != null ? ref : event.pageX - _this.canvas.offset().left) | 0;
            offsetY = ((ref1 = event.offsetY) != null ? ref1 : event.pageY - _this.canvas.offset().top) | 0;
      ...
      $(document).on('mousemove', (function(_this) {
        ...
        return function(event) {
          var len, p, ref, results, touch;
          if (_this.dragStart != null) {
            ref = event.originalEvent.changedTouches;
            results = [];
            for (p = 0, len = ref.length; p < len; p++) {
              ...
              results.push(panTo.call(_this, touch.pageX, touch.pageY));
            }
            return results;
          }
        };
        ...
        return function(event) {
          ...
          if (_this.dragStart != null) {
            ...
            for (p = 0, len = ref.length; p < len; p++) {
              ...
              event.preventDefault();
              results.push(stopPanning.call(_this, touch.pageX, touch.pageY, false));
            }
            return results;
          }
        };
    ...
    workerMessage = function(event) {
      var color, colorIndex, j, logDeltaV, logMaxDeltaV, logMinDeltaV, mean, p, q, ref, ref1, relativeDeltaV, stddev, x, y;
      if ('log' in event.data) {
        ...
        i = 0;
        j = 0;
        for (y = p = 0, ref = PLOT_HEIGHT; 0 <= ref ? p < ref : p > ref; y = 0 <= ref ? ++p : --p) {
          for (x = q = 0, ref1 = PLOT_WIDTH; 0 <= ref1 ? q < ref1 : q > ref1; x = 0 <= ref1 ? ++q : --q) {
    ...
    prepareCanvas = function() {
      var ctx, j, p, paletteKey, q, r, ref, s, x, y;
      ctx = this.canvasContext;
      ctx.save();
      ctx.lineWidth = 2;
      ...
      i = 0;
      for (y = r = 0, ref = PLOT_HEIGHT; 0 <= ref ? r < ref : r > ref; y = 0 <= ref ? ++r : --r) {
